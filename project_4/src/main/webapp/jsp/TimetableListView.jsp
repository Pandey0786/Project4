...
<body>
	...
	<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="100%">
				<tr>
					<td align="center"><label>Course Name :</label> <%=HTMLUtility.getList("clist", String.valueOf(bean.getCourse_Id()), cList)%>

						<label>Subject Name :</label> <%=HTMLUtility.getList("slist", String.valueOf(bean.getSubject_Id()), sList)%>

						<label>Date Of Exam :</label> <input type="text" name="Date"
